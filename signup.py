...
heading = Label(frame, text="Sign Up", font=(
    "Arial", 20, "bold"), bg="white", fg="#57a1f8")
...
user = Entry(frame, font=("Arial", 15), bg="white",
             fg="black", width=25, border=0)
...
email = Entry(frame, font=("Arial", 15), bg="white",
              fg="black", width=25, border=0)
...
phone = Entry(frame, font=("Arial", 15), bg="white",
              fg="black", width=25, border=0)
...
# button
Button(frame, text="Sign Up", font=("Arial", 15, "bold"), bg="#57a1f8",
       fg="white", width=23, border=0, command=signup).place(x=35, y=380)
Label(frame, text="Already have an account?", font=(
    "Arial", 10), bg="white", fg="black").place(x=90, y=420)

signin = Button(frame, text="Sign In", font=("Arial", 10, "bold"),
                bg="white", fg="#57a1f8", border=0, cursor="hand2", command=sign)
