...
Button(frame, text="Sign In", font=("Arial", 12, "bold"), bg="#57a1f8", fg="white", border=0, width=29, pady=7).place(x=30, y=204)
label=Label(frame, text="Don't have an account?", fg="black", bg="white", font=("Arial", 9, "bold"))
label.place(x=75, y=270)

sign_up = Button(frame, width=6, text="Sign Up", font=("Arial", 9, "bold"), bg="white", fg="#57a1f8", border=0, cursor="hand2")
